...
project = u'Display Calendar'
this_year = datetime.date.today().year
copyright = u'{}, Andreas Ruppen'.format(this_year)
version = pkg_resources.get_distribution('displayCalendar').version
release = version

exclude_patterns = ['_build', 'lib', 'bin', 'include', 'local']
pygments_style = 'sphinx'

htmlhelp_basename = 'displayCalendardoc'

man_pages = [
    ('index', 'display', u'display doc',
     [u'Andreas Ruppen'], 1)
]
